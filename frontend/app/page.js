        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {howItWorks.map((item, index) => (
              ...
              >
                <div
                  className={`w-full h-full p-6 rounded-xl ${item.bgClass} ${item.borderClass} border relative overflow-hidden transition-all duration-500 group-hover:shadow-lg ${item.hoverClass}`}
                >
                  {/* Hover shine effect */}
